...
Harness note
------------
``compute_fms_snapshot`` / ``momentum_now_and_delta`` are pure given DataFrames
(inject fixtures; do not call download_* inside unit tests). Logic will migrate
to ``core/`` gradually; this module remains the transitional facade.
